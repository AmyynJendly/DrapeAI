...
export default function ProductCard({ product, onTryOn }: ProductCardProps) {
  ...
  return (
    <div className="relative group">
      {/* Background Depth Card Layer matching Stitch Screen 2 */}
      <div className="absolute inset-0 bg-[#D9C4A9] rounded-[28px] transform translate-y-2 translate-x-2 group-hover:translate-y-3 group-hover:translate-x-3 transition-transform duration-300 -z-10" />

      {/* Main Card Content */}
      <div className="bg-white rounded-[28px] p-4 flex flex-col justify-between overflow-hidden shadow-lg border border-black/5 transition-all duration-300">
        {/* Image Container */}
